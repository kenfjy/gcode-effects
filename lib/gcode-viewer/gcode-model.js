var hideTravel = false;
var extrudeColor = 0xFFFFFF;
var travelColor = 0xFF0000;
...
function createObjectFromGCode(gcode) {
  ...
  var parser = new GCodeParser({
    ...
    G0: function(args, line) {
      ...
      var color = new THREE.Color(newLine.extruding ? extrudeColor : travelColor);

      if ((hideTravel && newLine.extruding) || !hideTravel) {
    ...
    G21: function(args) {
	 ...
	 G28: function(args) {
		 // nothing to do because it shouldn't be extruding
	 },
